# Remove unphysical results due to the aging CCD sensors.
# A more general program to fullfill this purpose.
...
def process(layFile, caseDir):
    ...
    # Construct polygon from the user-specified points
    ...
    pivDataFile = caseDir+"/1_Average_1_100.dat"
    ...
    footer = len(lines) - (5+imax*jmax)
    
    dataLines=StringIO(''.join(lines[5:-footer]))
    # Import PIV data
    data = np.genfromtxt(dataLines)
